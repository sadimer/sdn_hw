...
def mininet():
    ...
    info("*** Adding links\n")
    net.addLink(h1, s3, addr2="10:00:00:00:00:01")
    net.addLink(h2, s1, addr2="10:00:00:00:00:02")
    net.addLink(h3, s4, addr2="10:00:00:00:00:03")
    net.addLink(h4, s5, addr2="10:00:00:00:00:04")
    ...
    yield net, s1, s2, s3, s4, s5, h1, h2, h3, h4, h5, h6
    for mnobj in net, s1, s2, s3, s4, s5, h1, h2, h3, h4, h5, h6:
        mnobj.stop()
...
def test_connectivity_1(mininet, controller):
    net, s1, s2, s3, s4, s5, h1, h2, h3, h4, h5, h6 = mininet
    r1 = net.ping([h1, h2])
    r2 = net.ping([h1, h6])
    r3 = net.ping([h2, h6])
...
def test_mac_table(mininet, controller):
    assert filecmp.cmp("tests/task_2/test_5.out", "task_2.out") == True
